...
(function ($) {
  $.fn.html5lightbox = function (k) {
    ...
    l.options = jQuery.extend(
      {
        ...
        titlecss:
          "{color:#333333; font-size:16px; font-family:Armata,sans-serif,Arial; overflow:hidden; white-space:nowrap;}",
        errorwidth: 280,
        errorheight: 48,
        errorcss:
    ...
    l.options.htmlfolder = window.location.href.substr(
      0,
      window.location.href.lastIndexOf("/") + 1
    );
    if (
      l.options.skinfolder.charAt(0) != "/" &&
      l.options.skinfolder.substring(0, 5) != "http:" &&
      l.options.skinfolder.substring(0, 6) != "https:"
    )
    ...
    l.options.isIE =
      navigator.userAgent.match(/MSIE/i) != null && !l.options.isOpera;
    l.options.isIE9 = l.options.isIE && l.options.html5VideoSupported;
    l.options.isIE678 = l.options.isIE && !l.options.isIE9;
    l.options.isIE6 =
      navigator.userAgent.match(/MSIE 6/i) != null && !l.options.isOpera;
    ...
    l.options.isMobile =
      l.options.isAndroid || l.options.isIPad || l.options.isIPhone;
    l.options.isIOSLess5 =
      l.options.isIPad &&
      l.options.isIPhone &&
      (navigator.userAgent.match(/OS 4/i) != null ||
        navigator.userAgent.match(/OS 3/i) != null);
    l.options.supportCSSPositionFixed =
      !l.options.isIE6 && !l.options.isIOSLess5;
    ...
    l.createMarkup = function () {
      ...
      l.$lightbox = jQuery(
        "<div id='html5-lightbox' style='display:none;top:0px;left:0px;width:100%;height:100%;z-index:9999999;'>" +
          ...
          l.options.overlaybgcolor +
          ";opacity:" +
          l.options.overlayopacity +
          ";filter:alpha(opacity=" +
          Math.round(l.options.overlayopacity * 100) +
          ");'></div>" +
          ...
          l.options.skinfolder +
          l.options.loadingimage +
          "\") no-repeat center center;'></div>" +
          "<div id='html5-error' class='html5-error' style='display:none;position:absolute;padding:" +
          l.options.bordersize +
          "px;text-align:center;width:" +
          l.options.errorwidth +
          "px;height:" +
          l.options.errorheight +
          "px;'>" +
      ...
      if (l.options.stamp) {
        ...
        var d =
          "<img src='" + l.options.watermark + "' style='border:none;' />";
        if (l.options.watermarklink)
          d =
            "<a href='" +
            l.options.watermarklink +
            "' target='_blank'>" +
            d +
            "</a>";
        l.$watermark.html(d);
    ...
    l.clickHandler = function () {
      ...
      var d = Math.round(
        $(window).height() / 2 - (c + l.options.barheight) / 2
      );
    ...
    l.showImage = function (a, b, c) {
      ...
      var e = l.calcElemSize({ w: d, h: elemH });
      l.resizeLightbox(e.w, e.h, true, function () {
        l.$text.css({ width: l.calcTextWidth(e.w) });
    ...
    l.showSWF = function (a) {
      ...
      var d = l.calcElemSize({ w: b, h: c });
      b = d.w;
      c = d.h;
      l.resizeLightbox(b, c, true, function () {
        l.$text.css({ width: l.calcTextWidth(b) });
        l.$text.html(a[ELEM_TITLE]);
        l.$image
          .html(
    ...
    l.showVideo = function (d) {
      ...
      var g = l.calcElemSize({ w: e, h: f });
      e = g.w;
      f = g.h;
      l.resizeLightbox(e, f, true, function () {
        l.$text.css({ width: l.calcTextWidth(e) });
        ...
        if (l.options.isMobile) {
          ...
          (l.options.html5player || !l.options.flashInstalled) &&
          l.options.html5VideoSupported
        ) {
          if (
            !l.options.isFirefox ||
            (l.options.isFirefox && (d[ELEM_HREF_OGG] || d[ELEM_HREF_WEBM]))
          )
            a = true;
        }
        if (a) {
          ...
          l.embedFlash(
            ...
            e,
            f,
            l.options.jsfolder + "html5boxplayer.swf",
            "transparent",
            {
              width: e,
              height: f,
    ...
    l.showYoutubeVimeo = function (b) {
      ...
      var e = l.calcElemSize({ w: c, h: d });
      c = e.w;
      d = e.h;
      l.resizeLightbox(c, d, true, function () {
        l.$text.css({ width: l.calcTextWidth(c) });
        ...
        l.$image
          ...
          .show();
        var a = b[ELEM_HREF];
        if (b[m] == 3) a = l.prepareYoutubeHref(a);
    ...
    l.resizeWindow = function () {
      var a = Math.round(
        $(window).height() / 2 -
          (l.$lightboxBox.height() + l.options.barheight) / 2
      );
      l.$lightboxBox.animate({ "margin-top": a }, l.options.resizespeed);
    };
    l.calcElemSize = function (a) {
      var b =
        $(window).height() - l.options.barheight - 2 * l.options.bordersize;
      if (a.h > b) {
    ...
    l.showData = function () {
      ...
      l.$lightboxBox.animate(
        ...
        { queue: true, duration: l.options.resizespeed }
      );
    };
    l.resizeLightbox = function (a, b, c, d) {
      ...
      var h = Math.round(
        $(window).height() / 2 - (g + l.options.barheight) / 2
      );
      if (f == l.$elemWrap.width() && g == l.$elemWrap.height()) e = 0;
      l.$loading.hide();
      l.$watermark.hide();
      l.$lightboxBox.animate({ "margin-top": h }, e, function () {
        l.$lightboxBox.css({ width: f, height: g });
        l.$elemWrap
          .animate({ width: f }, e)
          .animate({ height: g }, e, function () {
            l.$loading.show();
            l.$watermark.show();
    ...
    l.showLightbox = function (a, b, c, d, e, f, g) {
      ...
      var j = Math.round(
        $(window).height() / 2 - (i + l.options.barheight) / 2
      );
  ...
  $.fn.amazingslider = function (G) {
    ...
    J.prototype = {
      ...
      readTags: function () {
        ...
        $(".amazingslider-slides", this.container)
          ...
          .each(function () {
            ...
            if (a.length > 0) {
              var b =
                a.data("src") && a.data("src").length > 0 ? a.data("src") : "";
              var c =
                a.attr("src") && a.attr("src").length > 0 ? a.attr("src") : b;
              var d =
                a.attr("alt") && a.attr("alt").length > 0 ? a.attr("alt") : "";
              var e =
                a.data("description") && a.data("description").length > 0
                  ? a.data("description")
                  : "";
              var f =
                a.parent() && a.parent().is("a") ? a.parent().attr("href") : "";
              var g =
                a.parent() && a.parent().is("a")
                  ? a.parent().attr("target")
                  : "";
              var h =
                a.parent() && a.parent().is("a")
                  ? a.parent().hasClass("html5lightbox")
                  : false;
        ...
        $(".amazingslider-thumbnails", this.container)
          ...
          .each(function (a) {
            ...
            if (b.length > 0 && m.elemArray.length > a) {
              var c =
                b.data("src") && b.data("src").length > 0 ? b.data("src") : "";
              var d =
                b.attr("src") && b.attr("src").length > 0 ? b.attr("src") : c;
              m.elemArray[a][ELEM_THUMBNAIL] = d;
            }
          });
        if (this.options.shownumbering) {
          for (var i = 0; i < this.elemArray.length; i++) {
            var n = this.options.numberingformat
              .replace("%NUM", i + 1)
      ...
      initVideoApi: function () {
        ...
        for (i = 0; i < this.elemArray.length; i++) {
          ...
          for (j = 0; j < videos.length; j++) {
            if (videos[j].type == TYPE_VIDEO_YOUTUBE) a = true;
      ...
      createSliderTimeout: function () {
        var b = this;
        this.sliderTimeout = new ASTimer(
        ...
        if (b.options.showtimer)
          $(".amazingslider-timer-" + b.id, b.container).css({
            ...
            filter:
              "alpha(opacity=" + Math.round(100 * b.options.timeropacity) + ")",
          });
      },
      ...
      playVideo: function (a) {
        ...
        var c = b[0].href;
        var d = b[0].type;
        if (d == TYPE_VIDEO_YOUTUBE) this.playYoutubeVideo(c, a);
        else if (d == TYPE_VIDEO_VIMEO) this.playVimeoVideo(c, a);
      },
      playVimeoVideo: function (b, c) {
        var d = $(".amazingslider-video-wrapper-" + this.id, this.container);
        d.css({ display: "block", width: "100%", height: "100%" });
      ...
      createText: function () {
        ...
        if (this.options.textstyle == "static") {
          ...
          n.css({ display: "none", overflow: "hidden", position: "absolute" });
        }
        $("head").append(
          "<style type='text/css'>" +
            ".amazingslider-text-" +
        ...
        this.container.bind("amazingslider.switchtext", function (f, g, h) {
          ...
          if (m.options.textstyle == "static") {
            ...
            if (
              !m.elemArray[h][ELEM_TITLE] &&
              !m.elemArray[h][ELEM_DESCRIPTION]
            )
              j.hide();
            else j.show();
              ...
              i.fadeOut(function () {
                ...
                switch (a) {
                  case "topleft":
                    ...
                    i.css({
                      margin:
                        m.options.textpositionmargintop +
                        "px " +
                        m.options.textpositionmarginleft +
                        "px",
                    });
                    break;
                  case "topright":
                    ...
                    i.css({
                      margin:
                        m.options.textpositionmargintop +
                        "px " +
                        m.options.textpositionmarginright +
                        "px",
                    });
                    break;
                  case "bottomleft":
                    ...
                    i.css({
                      margin:
                        m.options.textpositionmarginbottom +
                        "px " +
                        m.options.textpositionmarginleft +
                        "px",
                    });
                ...
                switch (c) {
                  ...
                  case "slide":
                    ...
                    e.delay(500).animate(
                      { left: "0%", opacity: 1 },
                      m.options.texteffectduration,
                      m.options.texteffecteasing
                    );
                    break;
                  default:
                    e.delay(500).show();
      ...
      createStyle: function () {
        $(".amazingslider-space-" + this.id, this.container).html(
      ...
      createArrows: function () {
        ...
        if (ASPlatforms.isIE678())
          b.css({ opacity: "inherit", filter: "inherit" });
        b.hover(
          function () {
        ...
        if (ASPlatforms.isIE678())
          c.css({ opacity: "inherit", filter: "inherit" });
        c.hover(
          function () {
            ...
            function () {
              a.arrowTimeout = setTimeout(function () {
                if (ASPlatforms.isIE678()) {
                  ...
                  $(
                    ".amazingslider-arrow-right-" + a.id,
                    a.container
                  ).fadeOut();
                }
      ...
      carMoveLeft: function () {
        ...
        var l =
          (isNaN(parseInt(b.css("margin-left")))
            ? 0
            : parseInt(b.css("margin-left"))) - c;
      ...
      carMoveBottom: function () {
        ...
        var l =
          (isNaN(parseInt(b.css("margin-top")))
            ? 0
            : parseInt(b.css("margin-top"))) + c;
      ...
      createNav: function () {
        ...
        var t =
          "navmarginy" in this.options
            ...
            : this.options.navmargin;
        g.css({ display: "block", position: "absolute", height: "auto" });
        ...
        if (this.options.navstyle != "none") {
          ...
          if (f.options.navthumbnavigationstyle == "auto") {
            ...
            if (
              (f.options.navdirection == "vertical" &&
                j.height() > h.height()) ||
              (f.options.navdirection == "horizontal" && j.width() > h.width())
            ) {
              var m =
                f.options.navthumbnavigationarrowimagewidth +
                f.options.navspacing;
              if (f.options.navdirection == "horizontal") {
                var n = Math.floor(
                  (g.width() - 2 * m + f.options.navspacing) /
                    (f.options.navwidth + f.options.navspacing)
                );
                m = Math.floor(
                  (g.width() -
                    n * f.options.navwidth -
                    (n - 1) * f.options.navspacing) /
                    2
                );
              }
              if (f.options.navdirection == "vertical")
              ...
              v.css({
                ...
                background:
                  "url('" +
                  f.options.skinsfolder +
                  f.options.navthumbnavigationarrowimage +
                  "') no-repeat left top",
              });
              w.css({
                overflow: "hidden",
              ...
              var p =
                f.options.navdirection == "vertical"
                  ? f.options.navwidth / 2 -
                    f.options.navthumbnavigationarrowimagewidth / 2
                  : f.options.navheight / 2 -
                    f.options.navthumbnavigationarrowimageheight / 2;
              if (
                f.options.navposition == "bottomleft" ||
                f.options.navposition == "bottomright" ||
                f.options.navposition == "bottom" ||
                f.options.navposition == "right"
              )
                p += o;
              if (f.options.navdirection == "vertical") {
                v.css({ top: "0px", left: "0px", "margin-left": p + "px" });
                w.css({ bottom: "0px", left: "0px", "margin-left": p + "px" });
              } else {
                v.css({ left: "0px", top: "0px", "margin-top": p + "px" });
                w.css({ right: "0px", top: "0px", "margin-top": p + "px" });
              }
              if (ASPlatforms.isIE678())
              ...
              if (ASPlatforms.isIE678())
                w.css({ opacity: "inherit", filter: "inherit" });
              w.hover(
                function () {
                  if (!$(this).data("disabled"))
          ...
          this.container.bind("amazingslider.switch", function (a, b, c) {
            $(".amazingslider-bullet-" + f.id + "-" + b, f.container)[
              "bulletNormal" + f.id
            ]();
            $(".amazingslider-bullet-" + f.id + "-" + c, f.container)[
              "bulletSelected" + f.id
            ]();
          });
          if (this.options.navshowpreview) {
        ...
        if (this.options.navshowbuttons) {
          ...
          if (this.options.navshowarrow) {
            ...
            if (this.options.navbuttoncolor)
              D.css({ "background-color": this.options.navbuttoncolor });
            ...
            D.hover(
              ...
              function () {
                if (f.options.navbuttoncolor)
                  $(this).css({ "background-color": f.options.navbuttoncolor });
                if (f.options.navarrowimage)
                  $(this).css({ "background-position": "left top" });
              }
            );
          ...
          if (this.options.navshowplaypause) {
            ...
            if (this.options.navbuttoncolor)
              E.css({ "background-color": this.options.navbuttoncolor });
            if (this.options.navarrowimage)
              E.css({
                "background-image":
                  "url('" +
            ...
            if (
              ...
              E.css({ display: f.isPaused ? "block" : "none" });
              $navPause.css({ display: f.isPaused ? "none" : "block" });
            }
          }
          if (this.options.navshowarrow) {
            var F = $(
            ...
            if (this.options.navbuttoncolor)
              F.css({ "background-color": this.options.navbuttoncolor });
            if (this.options.navarrowimage)
              F.css({
                "background-image":
                  "url('" +
      ...
      createNavBullet: function (r) {
        ...
        x.hover(
          function () {
            ...
            if (s.options.navshowpreview) {
              ...
              j.left += isNaN(parseInt(i.css("margin-left")))
                ? 0
                : parseInt(i.css("margin-left"));
              j.left += isNaN(parseInt(h.css("margin-left")))
                ? 0
                : parseInt(h.css("margin-left"));
              j.top += k.top + m.top;
              j.top += isNaN(parseInt(i.css("margin-top")))
                ? 0
                : parseInt(i.css("margin-top"));
              j.top += isNaN(parseInt(h.css("margin-top")))
                ? 0
                : parseInt(h.css("margin-top"));
              if (s.options.navdirection == "vertical") {
                var n = $(".amazingslider-nav-container-" + s.id, s.container);
                j.top += isNaN(parseInt(n.css("margin-top")))
                  ? 0
              ...
              var t,
                l =
                  j.left +
                  s.options.navwidth / 2 -
                  s.options.navpreviewwidth / 2 -
                  s.options.navpreviewborder;
              var o,
                tv =
                  j.top +
                  s.options.navheight / 2 -
                  s.options.navpreviewheight / 2 -
                  s.options.navpreviewborder;
              var p = {};
              switch (s.options.navpreviewposition) {
                case "bottom":
                  t =
                    j.top +
                    s.options.navheight +
                    s.options.navpreviewarrowheight;
                  p = { left: l + "px", top: t + "px" };
                  break;
                case "top":
                  t =
                    j.top -
                    s.options.navpreviewheight -
                ...
                case "left":
                  o =
                    j.left -
                    s.options.navpreviewwidth -
                    2 * s.options.navpreviewborder -
                    s.options.navpreviewarrowwidth;
                  p = { left: o + "px", top: tv + "px" };
                  break;
                case "right":
                  o =
                    j.left +
              ...
              $(q).load(function () {
                ...
                if (
                  ...
                  s.options.navpreviewwidth / s.options.navpreviewheight
                )
                  a =
                    "width:" +
                    s.options.navpreviewwidth +
                    ...
                    Math.floor(
                      ((this.height / this.width) * s.options.navpreviewwidth) /
                        2 -
                        s.options.navpreviewheight / 2
                    ) +
                    "px";
        ...
        if (this.options.navstyle == "bullets") {
          ...
          $(y).load(function () {
            ...
            if (
              this.width / this.height <=
              s.options.navimagewidth / s.options.navimageheight
            )
              a =
                "max-width:none !important;width:100%;height:auto;margin-top:-" +
                Math.floor(
                  ((this.height / this.width) * s.options.navimagewidth) / 2 -
                    s.options.navimageheight / 2
                ) +
                "px";
            else
              a =
                ...
                Math.floor(
                  ((this.width / this.height) * s.options.navimageheight) / 2 -
                    s.options.navimagewidth / 2
                ) +
                "px";
            x.append(
              "<div style='display:block;position:absolute;width:" +
                s.options.navimagewidth +
                "px;height:" +
                s.options.navimageheight +
                "px;overflow:hidden;'><img src='" +
                s.elemArray[r][ELEM_THUMBNAIL] +
                "' style='" +
                a +
                "' /></div>"
            );
            if (
              s.options.navshowplayvideo &&
              s.elemArray[r][ELEM_VIDEO].length > 0
            ) {
              x.append(
          ...
          $.fn["bulletNormal" + this.id] = function () {
            $(this).css({
              ...
              filter:
                "alpha(opacity=" + Math.round(100 * s.options.navopacity) + ")",
            });
          };
          ...
          $.fn["bulletSelected" + this.id] = function () {
            ...
            if (s.options.navshowfeaturedarrow) {
              var a = $(
                ".amazingslider-nav-featuredarrow-" + s.id,
                s.container
              );
              var b = $(this).position();
              ...
              if (s.options.navdirection == "horizontal") {
                var t,
                  l =
                    b.left +
                    s.options.navwidth / 2 -
                    s.options.navfeaturedarrowimagewidth / 2;
                if (
                  s.options.navposition == "top" ||
                  s.options.navposition == "topleft" ||
                  s.options.navposition == "topright"
                )
                  t = b.top + s.options.navheight;
                else t = b.top - s.options.navfeaturedarrowimageheight;
                a.css({ top: t + "px" });
                if (a.is(":visible")) {
                  a.stop(true, true).animate({ left: l + "px" });
                } else {
                  a.css({ display: "block", left: l + "px" });
                }
                if (c.width() < d.width() && !s.pauseCarousel) {
                  var m = Math.abs(
                    isNaN(parseInt(d.css("margin-left")))
                      ? 0
                      : parseInt(d.css("margin-left"))
                  );
                  if (
                    b.left < m ||
                    b.left + s.options.navwidth > m + c.width()
                  ) {
                    var e = -b.left;
                ...
                var l,
                  t =
                    b.top +
                    s.options.navheight / 2 -
                    s.options.navfeaturedarrowimageheight / 2;
                if (s.options.navposition == "left")
                  l = b.left + s.options.navwidth;
                else l = b.left - s.options.navfeaturedarrowimagewidth;
                a.css({ left: l + "px" });
                if (a.is(":visible")) {
                  a.stop(true, true).animate({ top: t + "px" });
                } else {
                  a.css({ display: "block", top: t + "px" });
                }
                if (c.height() < d.height() && !s.pauseCarousel) {
                  var m = Math.abs(
                    isNaN(parseInt(d.css("margin-top")))
                      ? 0
                      : parseInt(d.css("margin-top"))
                  );
                  if (
                    b.top < m ||
                    b.top + s.options.navheight > m + c.height()
                  ) {
                    var e = -b.top;
        ...
        $(i).load(function () {
          ...
          var e = $(
            "<div class='amazingslider-img-" +
              ...
              (100 - b) / 2 +
              "%;top:0%;' src='" +
              h.elemArray[h.curElem][ELEM_SRC] +
              "' /></div>"
          );
          if (d.length > 0) d.before(e);
          else c.append(e);
          var f =
            h.firstslide && !h.options.transitiononfirstslide
              ? ""
              : h.options.transition;
          h.firstslide = false;
          h.isAnimating = true;
          c.amazingsliderTransition(
            h.id,
            d,
            e,
            {
          ...
          if (h.elemArray[h.curElem][ELEM_LINK]) {
            ...
            c.unbind("click").bind("click", function () {
              if (h.elemArray[h.curElem][ELEM_LIGHTBOX]) {
                ...
                var a = h.elemArray[h.curElem][ELEM_TARGET]
                  ? h.elemArray[h.curElem][ELEM_TARGET]
                  : "_self";
          ...
          $(".amazingslider-play-" + h.id, h.container).css({
            display:
              h.elemArray[h.curElem][ELEM_VIDEO].length > 0 ? "block" : "none",
          });
        });
    ...
    this.each(function () {
      ...
      var j = {
        ...
        fade: { duration: 1000, easing: "easeOutQuad" },
        crossfade: { duration: 1000, easing: "easeOutQuad" },
        slide: { duration: 1000, easing: "easeOutElastic" },
        slice: {
          duration: 1500,
          easing: "easeOutQuad",
        ...
        blinds: { duration: 1500, easing: "easeOutQuad", slicecount: 4 },
        threed: {
          duration: 1500,
          easing: "easeOutQuad",
          slicecount: 4,
...
(function ($) {
  $.fn.amazingsliderTransition = function (a, b, c, d, e, f) {
    ...
    if (l == "fade") {
      ...
      if (k) {
        ...
        b.animate({ left: "-100%" }, i, j, function () {
          b.remove();
          e();
        });
      } else {
      ...
      g.sliceTransition(
        ...
        b,
        c,
        $.extend({ duration: i, easing: j, direction: k }, d["slice"]),
        e,
        f
      );
    } else if (l == "blinds") {
      ...
      g.blindsTransition(
        ...
        b,
        c,
        $.extend({ duration: i, easing: j, direction: k }, d["blinds"]),
        e,
        f
      );
    } else if (l == "threed") {
      ...
      g.threedTransition(
        ...
        b,
        c,
        $.extend({ duration: i, easing: j, direction: k }, d["threed"]),
        e,
        f
      );
    } else if (l == "threedhorizontal") {
      g.css({ overflow: "visible" });
      g.threedHorizontalTransition(
        a,
        b,
        c,
        $.extend(
          { duration: i, easing: j, direction: k },
          d["threedhorizontal"]
        ),
        e,
        f
      ...
      g.blocksTransition(
        ...
        b,
        c,
        $.extend({ duration: i, easing: j, direction: k }, d["blocks"]),
        e,
        f
      );
    } else if (l == "shuffle") {
      ...
      g.shuffleTransition(
        ...
        b,
        c,
        $.extend({ duration: i, easing: j, direction: k }, d["shuffle"]),
        e,
        f
      );
    } else {
  ...
  $.fn.sliceTransition = function (b, c, d, e, f, g) {
    ...
    for (i = 0; i < e.slicecount; i++) {
      ...
      var l = $("img", d)
        .clone()
        .css({ "max-width": "", left: "-" + j * i + "px" });
      l.attr(
        "style",
        l.attr("style") + "; " + "max-width:" + w + "px !important;"
      );
      k.append(l);
      h.append(k);
    }
    ...
    m.each(function () {
      ...
      switch (o) {
        case "up":
          a.css({ top: "", bottom: "0%", height: "0%" });
          break;
        case "down":
          a.css({ top: "0%", height: "0%" });
          break;
        case "updown":
          if (index % 2 == 0) a.css({ top: "0%", height: "0%" });
          else a.css({ top: "", bottom: "0%", height: "0%" });
          break;
      }
      setTimeout(function () {
        a.animate({ height: "100%" }, p, e.easing);
      }, q * index);
      index++;
    });
  ...
  $.fn.blindsTransition = function (c, d, e, f, g, h) {
    ...
    for (i = 0; i < f.slicecount; i++) {
      ...
      var n = $("img", e)
        .clone()
        .css({ "max-width": "", left: "-" + k * i + "px" });
      n.attr(
        "style",
        n.attr("style") + "; " + "max-width:" + w + "px !important;"
      );
      m.append(n);
      l.append(m);
      j.append(l);
  ...
  $.fn.threedTransition = function (d, e, f, g, j, k) {
    ...
    for (i = 0; i < g.slicecount; i++) {
      var o = $("img", f)
        .clone()
        .css({ "max-width": "", left: "-" + m * i + "px" });
      o.attr(
        "style",
        o.attr("style") + "; " + "max-width:" + w + "px !important;"
      );
      var p = $(
        "<div class='amazingslider-img-slice-" +
          d +
      ...
      q.attr(
        "style",
        q.attr("style") + "; " + "max-width:" + w + "px !important;"
      );
      var r = $(
        "<div class='amazingslider-img-slice-" +
          d +
        ...
        a.css(
          ASPlatforms.applyBrowserStyles({
            ...
            transform:
              ...
              "px" +
              ") rotateX(" +
              (g.direction ? "-89.99" : "89.99") +
              "deg)",
          })
        );
        a.animate({ left: "+=" + c + "px" }, y / 2 - 50, function () {
          a.animate({ left: "-=" + c + "px" }, y / 2 - 50);
        });
      }, x * index + 100);
      index++;
    });
  ...
  $.fn.threedHorizontalTransition = function (d, e, f, g, j, k) {
    ...
    for (i = 0; i < g.slicecount; i++) {
      var o = $("img", f)
        .clone()
        .css({ "max-height": "", top: "-" + m * i + "px" });
      o.attr(
        "style",
        o.attr("style") + "; " + "max-height:" + h + "px !important;"
      );
      var p = $(
        "<div class='amazingslider-img-slice-" +
          d +
      ...
      q.attr(
        "style",
        q.attr("style") + "; " + "max-height:" + h + "px !important;"
      );
      var r = $(
        "<div class='amazingslider-img-slice-" +
          d +
    ...
    v.each(function () {
      ...
      setTimeout(function () {
        ...
        a.animate({ top: "+=" + c + "px" }, y / 2 - 50, function () {
          a.animate({ top: "-=" + c + "px" }, y / 2 - 50);
        });
      }, x * index + 100);
      index++;
    });
  ...
  $.fn.blocksTransition = function (c, d, e, f, g, k) {
    ...
    t.each(function () {
      ...
      switch (p) {
        ...
        case "bottomright":
          a.delay(
            (f.duration * (b + col)) / (f.rowcount + f.columncount)
          ).fadeIn();
          break;
        case "top":
        case "bottom":
  ...
  $.fn.shuffleTransition = function (f, g, k, l, m, n) {
    ...
    y.each(function () {
      ...
      a.css(
        { left: d + "px", top: e + "px", opacity: 0 },
        l.duration,
        l.easing
      );
      a.animate(
        { left: c * p + "px", top: b * q + "px", opacity: 1 },
        l.duration,
        l.easing
      );
      index++;
